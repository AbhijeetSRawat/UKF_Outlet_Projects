...
export default function Summerwear() {
      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-4 grid-cols-1">
          ...
          <div className="lg:col-span-4 md:col-span-3">
            ...
            <h1 className='p-2 font-semibold text-3xl lg:flex hidden' style={{ fontFamily: "times new roman" }}>ALL SUMMER WEAR</h1>
            <div className="w-full">
              <video
                autoPlay
                muted
                ...
                className="w-full"
              >
                <source src="https://m.media-amazon.com/images/S/al-eu-726f4d26-7fdb/14ee4e45-8490-4bc1-a022-d2b7a644c369.mp4/productVideoOptimized.mp4" type="video/mp4" />
            ...
            <h1 className='p-2 font-semibold text-3xl lg:hidden flex' style={{ fontFamily: "times new roman" }}>ALL SUMMER WEAR</h1>
            <div className={` grid mt-5 ${open == 'one' ? "md:grid-cols-1 lg:grid-cols-2" : open == 'two' ? "md:grid-cols-2 lg:grid-cols-3" : open == "three" ? "md:grid-cols-3 lg:grid-cols-4" : "lg:grid-cols-4 md:grid-cols-3 grid-cols-2"} gap-2`}>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center'><Link to={'/detailspage'}><img className='hover:scale-105 duration-500' src="https://m.media-amazon.com/images/I/71y7r-gU7DL._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                ...
                <div><strong>Cricmarket.Com</strong></div>
                <div className='text-justify'>Cricmarket Men's Regular Fit Premium Plain V Neck Half...</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>1497</span></span>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/71LQ6D8ntsL._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                {/* <span className='text-gray-400 text-[13px]'>Sponsored !</span> */}
                <div><strong>Cricmarket.Com</strong></div>
                <div className='text-justify'>Women & Girls Black Solid Color Button Front Vacation...</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img width={100} className='hover:scale-105 duration-500 ' src="https://m.media-amazon.com/images/I/61tzuC7A-BL._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                {/* <span className='text-gray-400 text-[13px]'>Sponsored !</span> */}
                <div><strong>Soulfibre</strong></div>
                <div className='text-justify'>Soul Fibre Women’s Sleeveless Boho Bodycon Dress – Summ...</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>1,049</span></span>
                  <div className='text-gray-400'>M.R.P: <span className='line-through'>₹1,999</span></div>
                </div>
                <div>(48% OFF)</div>
                <Link to={'/addtocart'}><button className='p-1 bg-[#ecba49] rounded'>Add To Cart</button></Link>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/71qNVh9-h+L._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                {/* <span className='text-gray-400 text-[13px]'>Sponsored !</span> */}
                <div><strong>Cierge</strong></div>
                <div className='text-justify'>Women's Cotton Casual Style Printed Pyjama/Track Pant...</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>499</span></span>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/61Xh+gPuc0L._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                <div className='text-justify'>Men Relaxed Fit Rayon Night Wear Set</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>579</span></span>
                  <div className='text-gray-400'>M.R.P: <span className='line-through'>₹1,999</span></div>
                </div>
                <div>(71% OFF)</div>
                <Link to={'/addtocart'}><button className='p-1 bg-[#ecba49] rounded'>Add To Cart</button></Link>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/61QW9z6aw3L._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/71PPWK+0PLL._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                {/* <span className='text-gray-400 text-[13px]'>Sponsored !</span> */}
                <div><strong>UKF Outlet</strong></div>
                <div className='text-justify'>Men Co Ord Set for Men | Men...</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>629</span></span>
              ...
              <div className='p-2 overflow-hidden space-y-1  shadow'>
                <div className='flex justify-center items-center h-[50%] overflow-hidden'><Link to={'/detailspage'}><img className='hover:scale-105   duration-500' src="https://m.media-amazon.com/images/I/613UTdVVy6L._AC_UL480_FMwebp_QL65_.jpg" alt="" /></Link></div>
                {/* <span className='flex items-center gap-2'>
                  <span className='p-2 h-5 w-5 rounded-full bg-red-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-blue-600 cursor-pointer'></span>
                  <span className='p-2 h-5 w-5 rounded-full bg-green-600 cursor-pointer'></span>
                ...
                {/* <span className='text-gray-400 text-[13px]'>Sponsored !</span> */}
                <div><strong>UKF Outlet</strong></div>
                <div className='text-justify'>Mens Pyjama sets</div>
                <button className='p-1 text-[13px] rounded bg-gray-100 font-semibold'>Cocoa Calm</button>
                <div>⭐⭐⭐⭐⭐</div>
                <div className="flex items-center gap-1 justify-between">
                  <span>₹ <span className='font-semibold lg:text-[20px]'>579</span></span>
